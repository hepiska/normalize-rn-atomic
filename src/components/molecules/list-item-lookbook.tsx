...
import { Div, PressAbbleDiv, Image, Text } from '@components/atoms/basic'
...
class ListItemLookBook extends React.PureComponent<ListItemLookBookProps, any>{
  ...
  render() {
    ...
    return (
      <PressAbbleDiv _width='174px' _height='351px'
        ...
        <Image
          ...
          source={imageUri}
        />
        <Text fontSize='1.5rem' color='#333' _margin='4px 0px'>{title}</Text>
      </PressAbbleDiv>
    )
  }
}
