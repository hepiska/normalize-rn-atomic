...
import { Dimensions, Button, ViewStyle } from 'react-native'
    ...
    <Div _width='100%' style={style} align='flex-start'>
      ...
      <Div width="100%" _direction='row' wrap='wrap' justify='space-between'>
        {products.map(product => (
          <ProductCard key={product.id} product={product} style={{ width: ((width / 2) - 16 - 8), marginHorizontal: 0 }}></ProductCard>
        )
        )}
      </Div>
    </Div>
