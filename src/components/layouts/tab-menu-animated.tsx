...
// try to create animated transition
// const TabMenuNavigator = ({ items, x, selectedItem, selectedIndex }) => {
//   let itemLayout = {}
//   const [selectedLayout, setSelectedLayout] = React.useState({}) as any

//   React.useEffect(() => {
//     if (!itemLayout[selectedItem]) {
//       console.log('====sini')
//       setTimeout(() => {
//         setSelectedLayout(itemLayout[selectedItem] || {})
//       }, 300)
//     } else {
//       setSelectedLayout(itemLayout[selectedItem] || {})
//     }
...
//   const selectedWidth = selectedLayout ? selectedLayout.width : 10
//   let selectedPos: any = 0

//   if (selectedLayout.width) {
//     selectedPos = interpolate(x, {
//       inputRange: [(selectedIndex - 1) * width, (selectedIndex + 1) * width],
//       outputRange: [-selectedLayout.width, selectedLayout.width],
...
//           height: '100%',
//           transform: [{ translateX: selectedPos }],
//           left: selectedLayout?.x || 0,
...
//           key={item.name}
//           onLayout={e => {
//             const newitemLayout = { ...itemLayout }
//             newitemLayout[item.name] = e.nativeEvent.layout
//             console.log('====newlausa', newitemLayout)
